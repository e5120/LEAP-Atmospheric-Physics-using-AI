...
from leap.model.modules import SqueezeformerBlock
...
class SqueezeFormerEncoder(nn.Module):
    def __init__(self, input_size=25, dim=256, kernel_size=3, groups=4, num_heads=4, num_layers=12,
                 ...
                 activation='swish', prenorm=False):
        super().__init__()
...
class SqueezeFormerModel(BaseModel):
    def __init__(self, input_size, output_size, dim=128, num_layers=12, num_heads=4,
                 kernel_size=3, num_conv_block=1, num_attn_block=1, prenorm=False, activation="swish",
