...
class FFNModelV2(BaseModel):
    def __init__(self, input_size, hidden_sizes, output_size, num_scalar_feats=16, num_vector_feats=9, dropout=0.1):
        super().__init__()
        layers = []
        input_size = 2 * num_vector_feats * 59 + num_scalar_feats
    ...
    def forward(self, batch):
        ...
        inputs = torch.cat([scalar, vec_diff1, vec_diff2], dim=1)
